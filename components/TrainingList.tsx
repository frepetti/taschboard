  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="bg-surface-card border border-border-subtle rounded-xl p-12 text-center text-content-main shadow-sm">
          ...
          {trainings.map((training) => (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-3 mb-2">
                    <div>
                      <h3 className="text-content-main font-semibold mb-1">{training.titulo}</h3>
              ...
              <div className="flex items-center gap-2 mb-4">
                <span className="px-2 py-1 bg-surface-card-subtle text-content-muted border border-border-subtle text-xs rounded">
                  {training.categoria}
                </span>
                <span className="px-2 py-1 bg-surface-card-subtle text-content-muted border border-border-subtle text-xs rounded">
                  {training.nivel}
                ...
                {training.certificado_emitido && (
                  <span className="px-2 py-1 bg-amber-500/20 text-amber-500 dark:text-amber-400 text-xs rounded flex items-center gap-1 border border-amber-500/30">
              ...
              {training.attendee && (
                <div className="border-t border-border-subtle pt-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-content-muted text-xs mb-1">Mi Estado</p>
                      <p className="text-content-main text-sm font-medium capitalize">
                        {(training.attendee.estado_inscripcion || '').replace('_', ' ')}
                      </p>
                    </div>
                    {training.attendee.calificacion_evaluacion && (
                      <div className="text-right">
                        <p className="text-content-muted text-xs mb-1">Calificación</p>
                        <p className={`text-lg font-bold ${training.attendee.aprobo ? 'text-green-500' : 'text-red-500'
                          }`}>
                  ...
                  {training.attendee.certificado_emitido && (
                    <div className="mt-3 p-2 bg-green-500/10 border border-green-500/30 rounded text-green-500 text-xs flex items-center gap-2">
